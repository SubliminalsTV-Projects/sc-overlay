...
ArchVerse Overlay 0.1.34-r31 will reserve the **F key entirely for Star Citizen**.
...
Potential implementations include separate native windows per widget, X11 Shape/Input regions, or a Wayland layer-shell/native helper. This is intentionally deferred until the 0.1.34 Arch/Fedora port is stable.
